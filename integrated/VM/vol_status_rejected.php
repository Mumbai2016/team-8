...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Rejected candidates
...
$sql_fetch_volunteer = "SELECT * FROM volunteer_status WHERE status LIKE 'rejected'";
...
while($row = mysqli_fetch_array($result_fetch_volunteer)){
        echo '
         ...
         <div class="col-lg-3" id="volunteer">
                <select class="change_status" id="'.$row['vid'].'">
