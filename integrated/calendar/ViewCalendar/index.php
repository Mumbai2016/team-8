...
<body>
    <header style="display:block;position:relative;background:#222222;height:60px;width:100%">
        <img src="images/headerlogo.jpg" style="position:absolute;height:100%;width:auto;margin-left:10%">
			...
			?>
				{
					...
					icon: '<?php switch($event['branch']){
									...
									case "FE" : echo "graduation-cap";break;
								} ?>',
