...
$sql = "SELECT `cal_events`.event_id AS event_id, `cal_events`.event_name AS event_name, `cal_events`.start_date AS start_date, `cal_events`.location AS location, `cal_events`.end_date AS end_date, `cal_events`.event_desc AS description,`cal_events`.branch AS branch, `cal_events`.category AS category,`cal_events`.web_user AS web_user, `category_table`.category_color AS color, `category_table`.branch_indicator AS indicator FROM cal_events LEFT JOIN category_table ON `cal_events`.branch=`category_table`.name OR `cal_events`.category=`category_table`.name GROUP BY event_id";
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
				...
				<!--sidediv-->
						...
						<tr><td align="left">Technical</td><td style="border-radius: 40px!important;width:10px;" bgcolor="#0000FF"></td>
						</tr>
			  	...
			  	<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<select class="selectpicker form-control" name="branch[]" id="branch" multiple>
				  		...
				  		<div class="col-sm-6">
						  	<div class="form-group">
								<label for="event_start" class="col-sm-8 control-label">Start date</label>
							 	<input type="text" name="event_start" class="form-control datepicker" id="event_start">
						  	</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="event_end" class="col-sm-8 control-label">End date</label>
								<input type="text" name="event_end" class="form-control datepicker" id="event_end">
							</div>
						</div>
					</div>
				  	...
				  	<div class="form-group">
						...
						<textarea type="text" name="event_desc" rows="5" class="form-control" id="event_desc"></textarea>
				  	</div>
				  	<div class="form-group">
